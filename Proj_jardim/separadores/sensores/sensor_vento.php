...
$sql3 = "SELECT * FROM log_sensor_vento WHERE nome = '$nome'";
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="row rowInfoCard">
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted"> Deteção de vento </h5>
                                            <div class="metric-value d-inline-block">
                                                <?php
                                                if ($row["valor"] != 0) {
                                                    $estado = "Presença de vento";
                                                ?><h1 class=" badge badge-success"><?php echo $estado; ?></h1>
                                                <?php
                                                } else {
                                                    $estado = "Ausencia de vento";
                                                ?><h1 class=" badge badge-danger"><?php echo $estado; ?></h1>
                                                <?php
                                                }
                                                ?>
                                            </div>
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12 infoCard">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted">Velocidade Mensal</h5>
                                            <div class="metric-value d-inline-block">
                                                <h1 class="mb-1"></h1>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Velocidade Anual</h5>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1"></h1>
                                    </div>
                                </div>
