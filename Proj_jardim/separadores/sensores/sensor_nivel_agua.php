...
$sql3 = "SELECT * FROM log_sensor_agua WHERE nome = '$nome'";
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="row rowInfoCard">
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted"> Nivel de Agua Atual</h5>
                                            <div class="metric-value d-inline-block">
                                                <h1 class="mb-1"><?php echo $row["valor"] ?> cm</h1>
                                            </div>
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12 infoCard">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted">Nível médio Mensal</h5>
                                            <div class="metric-value d-inline-block">
                                                <h1 class="mb-1">15 cm</h1>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Nivel médio Anual</h5>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1">15 cm</h1>
                                    </div>
                                </div>
